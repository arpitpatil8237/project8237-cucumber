...
import org.POM_Pages.LogInPages;
...
//		lpg.clickOnLogOutBtn(); //
//		WebElement btn=driver.findElement(By.cssSelector("#logoutLink")); 
//		bu.waitForVisibilityOfEle(driver, 20, btn);
//		btn.click();
		 driver.quit();
	}
	...
	public void verifyLogInPageFunctionality() {
		...
		lpg.enterUserName(prop.getProperty("uName"));
		Reporter.log("UserName Entered");
		lpg.enterPassword(prop.getProperty("pwd"));
